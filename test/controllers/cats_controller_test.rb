...
class CatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cat" do
    assert_difference("Cat.count") do
      post cats_url, params: { cat: { breed: @cat.breed, favorite_quote: @cat.favorite_quote, name: @cat.name } }
    end
  ...
  test "should update cat" do
    patch cat_url(@cat), params: { cat: { breed: @cat.breed, favorite_quote: @cat.favorite_quote, name: @cat.name } }
